...
const App = {
  ...
  seedDefaultGoal() {
    const defaultGoalData = AIService.generateSmartOfflineBreakdown({
      title: 'ฝึกพูดภาษาอังกฤษสื่อสารมั่นใจในชีวิตประจำวัน',
      category: 'language',
      durationDays: 14,
      dailyMinutes: 25,
      level: 'เริ่มต้น',
      notes: 'เน้นฟังและพูดเพื่อความคล่องแคล่ว ไม่เน้นท่องไวยากรณ์ยากๆ'
    });
    ...
    const newGoal = {
      ...
      summary: defaultGoalData.summary,
      coachAdvice: defaultGoalData.coachAdvice,
      phases: defaultGoalData.phases,
      dailyTasks: defaultGoalData.dailyTasks
    };
